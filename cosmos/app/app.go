...
import (
	...
	"github.com/leejw51/cosmos/x/cosmos"
	cosmoskeeper "github.com/leejw51/cosmos/x/cosmos/keeper"
	cosmostypes "github.com/leejw51/cosmos/x/cosmos/types"
...
var (
	DefaultCLIHome = os.ExpandEnv("$HOME/.cosmoscli")
	DefaultNodeHome = os.ExpandEnv("$HOME/.cosmosd")
...
type NewApp struct {
	*bam.BaseApp
	...
	cosmosKeeper cosmoskeeper.Keeper
...
func NewInitApp(
	...
	app.cosmosKeeper = cosmoskeeper.NewKeeper(
		app.bankKeeper,
		app.cdc,
		keys[cosmostypes.StoreKey],
	)
...
type WasmWrapper struct { Wasm wasm.WasmConfig `mapstructure:"wasm"`}
	...
	app.mm = module.NewManager(
		...
		cosmos.NewAppModule(app.cosmosKeeper, app.bankKeeper),
