...
import (
	...
	"github.com/leejw51/cosmos/x/cosmos/client/cli"
	"github.com/leejw51/cosmos/x/cosmos/client/rest"
...
// RegisterCodec registers the cosmos module's types for the given codec.
...
// GetTxCmd returns the root tx command for the cosmos module.
func (AppModuleBasic) GetTxCmd(cdc *codec.Codec) *cobra.Command {
	return cli.GetTxCmd(cdc)
}

// GetQueryCmd returns no root query command for the cosmos module.
...
// NewHandler returns an sdk.Handler for the cosmos module.
...
// NewQuerierHandler returns the cosmos module sdk.Querier.
